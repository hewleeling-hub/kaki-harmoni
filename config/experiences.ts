...
export const experiences: Experience[] = [
  {
    ...
    tagline: "Switch off and sink in.",
    description:
      "A warm, dreamy soak for when your mind just won't quit — sink in and let the day melt away.",
    duration: "15 mins",
    icon: "moon",
    iconBg: "#6b4f9e",
    glowRgb: "107,79,158",
  ...
  },
  {
    ...
    tagline: "A warm hug for tired feet.",
    description:
      "Soft, soothing warmth that's gentle on everyone — made for anyone who needs a little extra care.",
    duration: "15 mins",
    icon: "blossom",
    iconBg: "#c8952f",
    glowRgb: "200,149,47",
  ...
  },
  {
    ...
    tagline: "Hit refresh.",
    description:
      "A bright, breezy soak that leaves you clear, light and ready for whatever's next.",
    duration: "15 mins",
    icon: "leaf",
    iconBg: "#2f7d46",
    glowRgb: "47,125,70",
  ...
  },
  {
    ...
    tagline: "Give tired legs a lift.",
    description:
      "Cool, reviving and light — a proper pick-me-up for legs that have done a little too much.",
    duration: "15 mins",
    icon: "legs",
    iconBg: "#1c8a8d",
    glowRgb: "28,138,141",
